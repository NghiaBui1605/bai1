  ...
  return (
    ...
    >
      <View style={styles.content}>
        <Image
          source={require('../assets/app_logo.png')} // Thay đổi đường dẫn đến logo của bạn
          style={styles.logo}
        />
...
const styles = StyleSheet.create({
  ...
  logo: {
    width: 48.47, // Điều chỉnh kích thước logo theo ý muốn
    height: 56.36, // Điều chỉnh kích thước logo theo ý muốn
    marginBottom: 20,
